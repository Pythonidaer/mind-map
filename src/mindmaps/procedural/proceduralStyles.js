const proceduralStyles = [
    ...
    {
      selector:
        'node#globalVars, node#godFunction, node#orderDependency',
      style: {
    ...
    {
      selector:
        'edge[source = "antipatterns"], edge[source = "globalVars"], edge[source = "godFunction"]',
      style: {
        'line-style': 'dashed',
  ...
  export default proceduralStyles;
