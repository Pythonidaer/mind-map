const imperativeStyles = [
    ...
    {
      selector:
        'node#spaghettiCode, node#excessiveMutability, node#tightCoupling, node#ignoredReturns',
      style: {
    ...
    {
      selector:
        'edge[source = "antipatterns"], edge[source = "spaghettiCode"], edge[source = "excessiveMutability"]',
      style: {
        'line-style': 'dashed',
